...
Generate a new public and private SSH key by running the following command:

   ```zsh
   curl https://raw.githubusercontent.com/bucaner0/public-dotfiles/main/ssh.sh | sh -s "<your-email-address>"
   ```
